...
twf = []
try:
    prox= requests.get('https://raw.githubusercontent.com/Jawid1/Jawid1/main/.prox.txt').text
...
prox = []
try:
    prox= requests.get('https://github.com/Jawid1/Jawid1/main/.prox.txt').text
    open('.prox.txt','w').write(prox)
except Exception as e:
    print(' WELCOME TO RANDOM CLONING SYSTEM')
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Jawid1/Jawid1/main/bbnew.txt').text
        ua=open('.bbnew.txt','w')
...
try:
    prox= requests.get('https://raw.githubusercontent.com/Jawid1/Jawid1/Professionals/main/.prox.txt').text
    open('.prox.txt','w').write(prox)
except Exception as e:
    print(' WELCOME TO RANDOM CLONING SYSTEM')
...
|__/  \__/ \______/ |__/  |__/|__/     \__/|______/|_______/ 
                         ...
                         AFG JAWID
\033[1;32m               \033[1;35mCREATED BY\33[0;m   :  \033[1;31mJAWID\33[0;m\033[1;39m Pro \033[1;35mTeam\33[0;m
\033[1;32m               \033[1;32mAUTHOR       :  \033[1;32mKJAWID
\033[1;32m               \033[1;36mGITHUB       :  \033[1;33mKJAWID
\033[1;32m               \033[1;32mSTATUS       :  \033[1;32mPaid
\033[1;32m               \033[1;34mVIRSION      :  \033[1;31m1.5.0 [ 0.1 ]
\33[37;44m\t         The best thing ! to do is to Start it..\33[0;m 
\033[1;32m--------------------------------------------------------------
""")

clear()
os.system("xdg-open https://www.facebook.com/profile.php?id=100004781928383")
xxxx = str(len(ugen))
...
def main():
    ...
    print(f"\033[1;97m[02] \033[1;92mJOIN TO BEST KJAWID")
    print(f"\033[1;97m[03] \033[1;92mJOIN TO KJAWID TEAM")
    ...
    if mirwais in ["1","01"]:
        ...
        os.system("xdg-open https://t.me/+4nWanLkItT45NGQ1")
        main()
...
def awm24():
    ...
    print(logo)   
    print('\033[1;32m--------------------------------------------------------------') 
    limit = int(input('\033[1;90m[+]\033[1;92m EXAMPLE \03n3[1;91m: \033[1;96m2000, 3000, 50000, 100000\n\033[1;32m------------------------------------------------\n\033[1;97m[+]\033[1;92m PUT IDS LIMIT \033[1;91m: \033[1;96m'))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(6))
        user.append(nmp)
    with ThreadPool(max_workers=30) as manshera:    
